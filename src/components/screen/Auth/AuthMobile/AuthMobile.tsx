        ...
        {type === 'login'
            ...
            <div className={styles.btnContainer}>
              ...
              <button type="submit" disabled={!isValid}>
                <Button className={styles.btnAuth} color="Pink" disabled={!isValid}>Войти</Button>
              </button>
            </div>
            )}
        {type === 'registration'
            ...
            <div className={styles.btnContainer}>
              ...
              <button type="submit" disabled={!isValid}>
                <Button className={styles.btnAuth} color="Pink" disabled={!isValid}>Зарегистрироваться</Button>
              </button>
            </div>
            )}
      </form>
