  ...
  >
    ...
    >
      ...
      <div className={styles.containerLink}>
        <a className={styles.iconLink} href="https://vk.com/arsenkhuranovran" target="_blank" rel="noreferrer">
          {color === 'black' && <img src={vkWhite} alt="vk" />}
          {color === 'white' && <img src={vkBlack} alt="vk" />}
        </a>
        <a className={styles.iconLink} href="https://vk.com/id243699437" target="_blank" rel="noreferrer">
          {color === 'black' && <img src={vkWhite} alt="vk" />}
          {color === 'white' && <img src={vkBlack} alt="vk" />}
        </a>
        <a className={styles.iconLink} href="https://vk.com/id398089965" target="_blank" rel="noreferrer">
          {color === 'black' && <img src={vkWhite} alt="vk" />}
          {color === 'white' && <img src={vkBlack} alt="vk" />}
        </a>
      </div>
