  ...
  return (
    ...
    >
      <div className={styles.userMenu}>
        <div
          className={cn(styles.inputUserMenu, {
      ...
      {isVisibleDropdown === 'visible' && <div className={styles.closeBackground} onClick={() => setIsVisibleDropdown('invisible')} />}
    </div>
  );
};
